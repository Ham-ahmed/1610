...
echo -e "${CYAN}"
echo "################################################################"
echo "#      Start downloading and installing  e2m3u2bouquet         #"
echo "#####################################################$$$$$$$####"
echo -e "${NC}"

IPK_URL="https://raw.githubusercontent.com/Ham-ahmed/1610/refs/heads/main/enigma2-plugin-extensions-e2m3u2bouquet_2.0.12_all.ipk"
IPK_NAME="enigma2-plugin-extensions-e2m3u2bouquet_2.0.12_all.ipk"
