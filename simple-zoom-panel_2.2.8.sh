...
echo -e "${CYAN}"
echo "################################################################"
echo "#      Start downloading and installing  simple-zoom-panel     #"
echo "#####################################################$$$$$$$####"
echo -e "${NC}"

IPK_URL="https://raw.githubusercontent.com/Ham-ahmed/1610/refs/heads/main/enigma2-plugin-extensions-simple-zoom-panel_2.2.8_all.ipk"
IPK_NAME="enigma2-plugin-extensions-simple-zoom-panel_2.2.8_all.ipk"
