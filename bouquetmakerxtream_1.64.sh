...
echo -e "${CYAN}"
echo "################################################################"
echo "#      Start downloading and installing  bouquetmakerxtream    #"
echo "#####################################################$$$$$$$####"
echo -e "${NC}"

IPK_URL="https://raw.githubusercontent.com/Ham-ahmed/1610/refs/heads/main/enigma2-plugin-extensions-bouquetmakerxtream_1.64.20251014_all.ipk"
IPK_NAME="enigma2-plugin-extensions-bouquetmakerxtream_1.64.20251014_all.ipk"
...
echo ""
echo "#################################################################"
echo "#${GREEN}                  تم التثبيت ب                ${PURPLE}#"
echo "#${BLUE}               ON - plugin v6.4 v6             ${PURPLE}#"
