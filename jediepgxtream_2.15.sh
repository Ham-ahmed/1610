...
echo -e "${CYAN}"
echo "################################################################"
echo "#      Start downloading and installing  jediepgxtream         #"
echo "#####################################################$$$$$$$####"
echo -e "${NC}"

IPK_URL="https://raw.githubusercontent.com/Ham-ahmed/1610/refs/heads/main/enigma2-plugin-extensions-jediepgxtream_2.15.20251011_all.ipk"
IPK_NAME="enigma2-plugin-extensions-jediepgxtream_2.15.20251011_all.ipk"
